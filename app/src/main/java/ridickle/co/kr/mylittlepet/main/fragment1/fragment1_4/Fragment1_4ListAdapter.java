...
public class Fragment1_4ListAdapter extends RecyclerView.Adapter<Fragment1_4ListAdapter.PopularViewHolder> {
    Context context;
    ArrayList<Network_Popular> popularList;

    public Fragment1_4ListAdapter(Context context){
    ...
    public class PopularViewHolder extends RecyclerView.ViewHolder {
        ...
        public PopularViewHolder(View itemView) {
            super(itemView);
            logoImage = (ImageView) itemView.findViewById(R.id.f1_4LogoImage);
            popularTitle = (TextView) itemView.findViewById(R.id.f1_4PopularTitle);
            popularName = (TextView) itemView.findViewById(R.id.f1_4PopularName);
        }
    }

    public PopularViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.item_tab1_fragment4, parent, false);
