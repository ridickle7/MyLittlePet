...
public class MainF1_2PresenterImpl implements MainF1_2Presenter {
    private static MainF1_2Presenter instance = null;
    private static MainF1_2Presenter.fragment fragment = null;
    private static MainF1_2Model model = null;

    public static synchronized MainF1_2Presenter getInstance(MainF1_2Presenter.fragment fr) {
        if (instance == null) {
            ...
            public void onResponse(Call<Network_FamousFace> call, Response<Network_FamousFace> response) {
                ...
                if (response.body() != null) {
                    ...
                    for (int i = 0; i < faceList.length; i++) {
                        Log.d(MainF1Fragment2.TAG, faceList[i].getCelebrity().getValue());
                    ...
                    Log.d(MainF1Fragment2.TAG, "닮은 것 따위 없음");
    ...
    public File loadImageFile(Intent intent) {
        MainF1Fragment2 tempFragment = ((MainF1Fragment2) fragment);
