...
import static ridickle.co.kr.mylittlepet.main.fragment1.fragment1_1.MainF1Fragment1.TAG;
    ...
    public void cameraSelectorSetting(LinearLayout view){
        view.findViewById(R.id.cameraLibrary).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((MainF1Fragment1)fragment).startActivityForResult(intent, CAMERALIBRARY);
            }
        });
        ...
        view.findViewById(R.id.cameraCapture).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((MainF1Fragment1)fragment).startActivityForResult(intent, CAMERACAPTURE);
            }
        });
    }
}
