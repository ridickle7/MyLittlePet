 ...
 */
public class QnaDetailAdapter extends ArrayAdapter<Qna> {
    ...
    public QnaDetailAdapter(Context context, int resource, List<Qna> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.content.setText(data.get(position).getComment().toString());
        holder.comment_num.setText(data.get(position).getComment().toString());
        holder.nickname.setText(data.get(position).getName().toString());
